...
################################################################################
namespace eval ::preed {
	set mysql_(user) 			"sql_user"
	set mysql_(password) 		"sql_pass"
	set mysql_(host) 			"sql_hostip"
	set mysql_(db) 				"sql_database"
	set mysql_(table) 			"sql_tabledb"
	################################################################################
	set db_(id) 				"id"
