...
if { ${addpre_(section)} == "" } {
 set IRC_MSG [format "\002\0033(\00314ADDPRE\0033)\002\0037 Syntax * !addpre <nom.de.la.release> <section>"]
...
append SQL_INSERT          "`${::PREEDb0t::db_(ctime)}`, `${::PREEDb0t::db_(rlsstatus)}` "
append SQL_INSERT       ") VALUES ( "
append SQL_INSERT           "'${addpre_(release)}', '${addpre_(group)}', '${addpre_(section)}', "
append SQL_INSERT           "'${addpre_(time)}', 'addpre' "
append SQL_INSERT       ");"
